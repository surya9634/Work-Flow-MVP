    ...
    (
        ...
        return (
            <div className={cn("relative min-h-screen", className)} ref={ref} {...props}>
                ...
                <section className="relative max-w-full mx-auto z-1 pt-24">
                    ...
                    <div className="max-w-screen-xl z-10 mx-auto px-4 gap-12 md:px-8">
                        <div className="space-y-5 max-w-3xl leading-0 lg:leading-5 mx-auto text-center">
                                ...
                                <div className="flex items-center justify-center gap-3 md:gap-4 pt-2 flex-wrap">
                                    {steps.map((step, i) => (
                                        <React.Fragment key={i}>
                                            <div className="flex items-center gap-2 px-4 py-2 rounded-full bg-zinc-900/80 border border-zinc-800 text-sm text-zinc-300">
                            ...
                            <div className="items-center justify-center gap-x-3 space-y-3 sm:flex sm:space-y-0">
                                <span className="relative inline-block overflow-hidden rounded-full p-[1.5px] animate-glow-pulse">
                        ...
                        {/* Bottom Content (Children or Image) */}
                        <div className="mt-12 mx-10 relative z-10">
                            {children ? children : bottomImage && (
                                <div>
                                    <img
